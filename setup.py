...
setup(name='gen_basis_helpers',
	  ...
	  packages = ['gen_basis_helpers','gen_basis_helpers.adsorption' ,'gen_basis_helpers.convergers','gen_basis_helpers.castep','gen_basis_helpers.castep.private',
	              ...
	              'gen_basis_helpers.job_helpers.cp2k','gen_basis_helpers.job_helpers.plato', 'gen_basis_helpers.misc',
