...
setup(name='gen_basis_helpers',
	  ...
	  packages = ['gen_basis_helpers','gen_basis_helpers.convergers','gen_basis_helpers.castep','gen_basis_helpers.castep.private',
	              ...
	              'gen_basis_helpers.job_utils', 'gen_basis_helpers.job_helpers', 'gen_basis_helpers.job_helpers.castep', 'gen_basis_helpers.job_helpers.plato',
