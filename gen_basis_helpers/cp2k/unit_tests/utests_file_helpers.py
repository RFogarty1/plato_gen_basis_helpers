...
def _loadExpectedOutputSimpleMDOptionsA():
	...
	newStr += "    ENSEMBLE NVT\n"
	newStr += "    STEPS 100\n"
	newStr += "    STEP_START_VAL 20\n"
	newStr += "    TIME_START_VAL 200\n"
	newStr += "    TIMESTEP 0.5\n"
...
def _loadExpectedOutNudgedBandFile_noReplicasSet():
	...
	newStr += "    &OPTIMIZE_BAND\n"
	newStr += "      OPTIMIZE_END_POINTS TRUE\n"
	newStr += "    &END OPTIMIZE_BAND\n"
	newStr += "  &END BAND\n"
	newStr += "&END MOTION\n"
...
def _loadExpectedOutputHirshfeldOpts():
	...
	newStr += "    &PRINT\n"
	newStr += "      &HIRSHFELD ON\n"
	newStr += "        SELF_CONSISTENT TRUE\n"
	newStr += "        SHAPE_FUNCTION DENSITY\n"
	newStr += "      &END HIRSHFELD\n"
	newStr += "    &END PRINT\n"
	outStr = outStr.replace("  &DFT\n",newStr)
	return outStr
