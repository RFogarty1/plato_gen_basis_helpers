...
def _getHydrogenMolOptSZVBasis():
	return basObj.CP2KBasisObjStandard( element="will_be_overwritten", basis="SZV-MOLOPT-GTH-q1",
...
def _getHydrogenMolOptDZVPBasis():
	return basObj.CP2KBasisObjStandard( element="will_be_overwritten", basis="DZVP-MOLOPT-GTH",
	                             potential="GTH-PBE-q1", potFile="GTH_POTENTIALS", basisFile="BASIS_MOLOPT" )

#6 basis functions
@basRegister.decoRegisterCP2KBasisCreatorToMethodStr("H-GTH-PBE-q6-MolOpt-sssp".lower())
def _getHydrogenMolOptTZVPBasis():
	return basObj.CP2KBasisObjStandard( element="will_be_overwritten", basis="TZVP-MOLOPT-GTH",
	                             potential="GTH-PBE-q1", potFile="GTH_POTENTIALS", basisFile="BASIS_MOLOPT" )
...
def _getHydrogenMolOptTZV2PBasis():
	return basObj.CP2KBasisObjStandard( element="will_be_overwritten", basis="TZV2P-MOLOPT-GTH",
	                             potential="GTH-PBE-q1", potFile="GTH_POTENTIALS", basisFile="BASIS_MOLOPT" )

#14 basis functions
@basRegister.decoRegisterCP2KBasisCreatorToMethodStr("H-GTH-PBE-q6-MolOpt-sssppd".lower())
def _getHydrogenMolOptTZV2PXBasis():
	return basObj.CP2KBasisObjStandard( element="will_be_overwritten", basis="TZV2PX-MOLOPT-GTH",
	                             potential="GTH-PBE-q1", potFile="GTH_POTENTIALS", basisFile="BASIS_MOLOPT" )
