...
def _modBinvalGetterWithFilterIndices(binValGetter, groupIndices, useGroups, **kwargs):
...
class WaterToWaterFilteredAtomComboBinvalGetterGeneric(atomComboCoreHelp._GetOneDimValsToBinFromSparseMatricesBase):
	...
	def getValsToBin(self, sparseMatrixCalculator):
		...
		_modBinvalGetterWithFilterIndices(self.binValGetter, groupIndices, self.useGroups, toIdxType=self.toIdxType)
